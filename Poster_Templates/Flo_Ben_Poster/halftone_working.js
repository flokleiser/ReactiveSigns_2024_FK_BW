...
function applyHalftone(blurAmount) {
    ...
    let maxSize = constrain(map(blurAmount, 0, 20, gridSize * 2, gridSize), gridSize * 0.25, gridSize );
    ...
    for (let y = 0; y < height; y += gridSize) {
        for (let x = 0; x < width; x += gridSize) {
            ...
            let circleOpacity = map(blurAmount, 0, 1, 0, 255);
